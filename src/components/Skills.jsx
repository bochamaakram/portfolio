...
import { SiJavascript, SiTypescript, SiGraphql, SiDocker } from 'react-icons/si';
import '../styles/skills.css';

const skills = [
  { name: 'Frontend', icon: <FaReact />, items: ['React', 'Next.js', 'Redux', 'HTML/CSS', 'Tailwind', 'bootstrap', 'blade'] },
  { name: 'Backend', icon: <FaLaravel />, items: ['Node.js', 'Laravel', 'Symfony', 'Express', 'NestJS', 'REST APIs', 'Authentication'] },
  { name: 'Database', icon: <FaDatabase />, items: ['MongoDB', 'MySQL', 'Mongoose'] },
