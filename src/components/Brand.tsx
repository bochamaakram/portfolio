  ...
  return (
    <div
      ...
      style={{
        ...
        // Make the background gradient fill the text using standard background clip
        color: background ? 'transparent' : 'currentColor',
        backgroundImage: background,
        backgroundClip: background ? 'text' : undefined,
        WebkitBackgroundClip: background ? 'text' : undefined,
        // Match the aspect ratio approximately for the new text layout
        aspectRatio: '157 / 9',
        overflow: 'hidden',
      }}
      {...rest}
